...
from app.models.pay.pay_order_callback_data import PayOrderCallbackData
        ...
        if pay_order_items:
            ...
            for item in pay_order_items:
                ...
                if tmp_food_info:
                    ...
                    with db.auto_commit():
                        tmp_food_info
                    PayService.set_stock_change_log(item.food_id, item.quantity, '订单取消')
